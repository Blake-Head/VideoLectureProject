...
Please do your best to keep files organized! Ideally, no additional files should be put into the top folder.

Also, when setting up your .gitignore, make sure to add your media folder created by manim, otherwise you'll be uploading megabytes worth of video data to the repo!  

When tinkering with little animations here and there, testing, etc, you should have these files tucked away in your own named user folder, which will be found in the "Use Workspaces" folder. If one of those files becomes a main video file, please move it over to the relevant folder in Physics 1 or Physics 2.

> [!WARNING]
> Please do your best to keep everything organized! Over time there could be dozens of individual files here!
> Also, practice good file naming conventions!